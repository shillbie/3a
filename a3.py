...
cl = LINETCR.LINE()
cl.login(token="EnwdVFk4iQcdIZZi6pWd.t9bOCFBZsWK6oxk4TD6ppq.YMUkrOsfPmJek+eEq4HkLTLxju3BI6lIuiDfKGPn9bg=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Enehr4x9LeoSQ4vUnUq3.m5X5B34I0MLNJSqaZLZ5uW.v9z73gWcamyEtqqgMzYeLgLR3Hq7XJVdtoAVZA5Buls=")
ki.loginResult()
